...
class Seq2SeqTrainer(Trainer):
    ...
    def prediction_step(
        ...
        # ! 自己给加的是为了适应没m2m100这样的多语言模型的训练，为其增加一个forced_bos 是lang_code_token_id
        if hasattr(self.model.generation_config, "forced_bos_token_id") and self.model.generation_config.forced_bos_token_id!=None \
            and "forced_bos_token_id" not in gen_kwargs:
            gen_kwargs['forced_bos_token_id'] = self.model.generation_config.forced_bos_token_id
